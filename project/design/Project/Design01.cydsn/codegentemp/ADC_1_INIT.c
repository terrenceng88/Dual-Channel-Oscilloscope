...
static const cy_stc_sar_config_t ADC_1_hwConfigs[ADC_1_TOTAL_CONFIGS] = {
    /*Configuration 0*/
    {
        ...
        (uint32_t) (ADC_1_SARMUX__CH_2_PORT << SAR_CHAN_CONFIG_POS_PORT_ADDR_Pos) |
        (uint32_t) ADC_1_SARMUX__CH_2_PIN
        #ifdef ADC_1_SARMUX__CH_2_MINUS_PIN
            | (uint32_t) (ADC_1_SARMUX__CH_2_MINUS_PIN << SAR_CHAN_CONFIG_NEG_PIN_ADDR_Pos) 
            | (uint32_t) (ADC_1_SARMUX__CH_2_MINUS_PORT  << SAR_CHAN_CONFIG_NEG_PORT_ADDR_Pos)
            | SAR_CHAN_CONFIG_NEG_ADDR_EN_Msk
        #else
        #endif
        | (uint32_t) (1 << SAR_CHAN_CONFIG_SAMPLE_TIME_SEL_Pos),
        (uint32_t) (ADC_1_SARMUX__CH_3_PORT << SAR_CHAN_CONFIG_POS_PORT_ADDR_Pos) |
        (uint32_t) ADC_1_SARMUX__CH_3_PIN
        #ifdef ADC_1_SARMUX__CH_3_MINUS_PIN
            | (uint32_t) (ADC_1_SARMUX__CH_3_MINUS_PIN << SAR_CHAN_CONFIG_NEG_PIN_ADDR_Pos) 
            | (uint32_t) (ADC_1_SARMUX__CH_3_MINUS_PORT  << SAR_CHAN_CONFIG_NEG_PORT_ADDR_Pos)
            | SAR_CHAN_CONFIG_NEG_ADDR_EN_Msk
        #else
        #endif
        | (uint32_t) (1 << SAR_CHAN_CONFIG_SAMPLE_TIME_SEL_Pos),
