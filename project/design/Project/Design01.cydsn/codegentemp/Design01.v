...
module Scan_ADC_v3_10_0 (
	...
	cy_clock_v1_0
		#(.id("0bccf7bf-16d4-4597-82a4-570cbffeb345/f7143d07-534d-4542-813a-8bb23ceb1ae9"),
...
module SCB_UART_PDL_v2_0_2 (
	...
	cy_clock_v1_0
		#(.id("bbbf2394-3ee8-4d48-b488-88c28e8fe1f1/b68e5b9d-7828-482d-a282-930f990e3b3e"),
		  .source_clock_id(""),
		  .divisor(0),
...
// DMA_PDL_v2_0(BUFFERABLE=false, CHAIN_TO_1=0, CHAIN_TO_2=0, CHAIN_TO_3=0, CHAIN_TO_4=0, CHANNEL_PRIORITY=3, DATA_ELEMENT_SIZE_1=2, DATA_ELEMENT_SIZE_2=2, DATA_ELEMENT_SIZE_3=2, DATA_ELEMENT_SIZE_4=2, DESCR_NAME_1=Descriptor_1, DESCR_NAME_2=Descriptor_2, DESCR_NAME_3=Descriptor_3, DESCR_NAME_4=Descriptor_4, DESCRIPTORS_XML_STR=<?xml version="1.0" encoding="utf-16"?> <ArrayOfCyDmaDescriptionProperties xmlns:Version="ystem.Collections.Generic">   <CyDmaDescriptionProperties>     <DescriptorName>Descriptor_1</DescriptorName>     <Interrupt>CY_DMA_INTR_DESCR_CMPLT</Interrupt>     <ChainToDescriptor>Descriptor_2</ChainToDescriptor>     <DataElementSize>CY_DMA_HALFWORD</DataElementSize>     <SourceAndDestinationTransferWidth>WordToHalfword</SourceAndDestinationTransferWidth>     <NumberOfDataElementsToTransfer>256</NumberOfDataElementsToTransfer>     <SourceIncrementEveryCycleByX>0</SourceIncrementEveryCycleByX>     <NumberOfXLoopsToExecute>2</NumberOfXLoopsToExecute>     <SourceIncrementEveryCycleByY>0</SourceIncrementEveryCycleByY>     <DestinationIncrementEveryCycleByY>256</DestinationIncrementEveryCycleByY>   </CyDmaDescriptionProperties>   <CyDmaDescriptionProperties>     <DescriptorName>Descriptor_2</DescriptorName>     <Interrupt>CY_DMA_INTR_DESCR_CMPLT</Interrupt>     <ChainToDescriptor>Descriptor_1</ChainToDescriptor>     <DataElementSize>CY_DMA_HALFWORD</DataElementSize>     <SourceAndDestinationTransferWidth>WordToHalfword</SourceAndDestinationTransferWidth>     <NumberOfDataElementsToTransfer>256</NumberOfDataElementsToTransfer>     <SourceIncrementEveryCycleByX>0</SourceIncrementEveryCycleByX>     <NumberOfXLoopsToExecute>2</NumberOfXLoopsToExecute>     <SourceIncrementEveryCycleByY>0</SourceIncrementEveryCycleByY>     <DestinationIncrementEveryCycleByY>256</DestinationIncrementEveryCycleByY>   </CyDmaDescriptionProperties> </ArrayOfCyDmaDescriptionProperties>, DST_WIDTH_1=0, DST_WIDTH_2=0, DST_WIDTH_3=0, DST_WIDTH_4=0, INTR_OUT_1=0, INTR_OUT_2=0, INTR_OUT_3=0, INTR_OUT_4=0, MIGRATION=false, NUM_OF_DESCRIPTORS=2, PREEMPTABLE=false, SRC_WIDTH_1=0, SRC_WIDTH_2=0, SRC_WIDTH_3=0, SRC_WIDTH_4=0, TRIG_DEACT_1=0, TRIG_DEACT_2=0, TRIG_DEACT_3=0, TRIG_DEACT_4=0, TRIG_IN_TYPE_1=0, TRIG_IN_TYPE_2=0, TRIG_IN_TYPE_3=0, TRIG_IN_TYPE_4=0, TRIG_INPUT=true, TRIG_OUT_TYPE_1=0, TRIG_OUT_TYPE_2=0, TRIG_OUT_TYPE_3=0, TRIG_OUT_TYPE_4=0, TRIG_OUTPUT=false, X_DST_INCREMENT_1=1, X_DST_INCREMENT_2=1, X_DST_INCREMENT_3=1, X_DST_INCREMENT_4=1, X_NUM_OF_ELEMENTS_1=1, X_NUM_OF_ELEMENTS_2=1, X_NUM_OF_ELEMENTS_3=1, X_NUM_OF_ELEMENTS_4=1, X_SRC_INCREMENT_1=1, X_SRC_INCREMENT_2=1, X_SRC_INCREMENT_3=1, X_SRC_INCREMENT_4=1, Y_DST_INCREMENT_1=1, Y_DST_INCREMENT_2=1, Y_DST_INCREMENT_3=1, Y_DST_INCREMENT_4=1, Y_NUM_OF_ELEMENTS_1=1, Y_NUM_OF_ELEMENTS_2=1, Y_NUM_OF_ELEMENTS_3=1, Y_NUM_OF_ELEMENTS_4=1, Y_SRC_INCREMENT_1=1, Y_SRC_INCREMENT_2=1, Y_SRC_INCREMENT_3=1, Y_SRC_INCREMENT_4=1, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=DMA_PDL_v2_0, CY_CONFIG_TITLE=DMA_2, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=DMA_2, CY_INSTANCE_SHORT_NAME=DMA_2, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=dma, CY_PDL_DRIVER_REQ_VERSION=2.0.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=DMA_2, )
...
module top ;
	...
	cy_mxs40_gpio_v1_0
		#(.id("abbdf5d7-388a-4ad4-ae1c-104b26e4f757"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
    ...
    DMA_PDL_v2_0_1 DMA_1 (
        .interrupt(Net_64),
        .tr_in(Net_76),
        .tr_out(Net_75));

	wire [0:0] tmpFB_0__ANALOG_IN_net;
	wire [0:0] tmpIO_0__ANALOG_IN_net;
	...
	cy_mxs40_gpio_v1_0
		...
		ANALOG_IN
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__ANALOG_IN_net[0:0]}),
		  .analog({Net_105}),
		  .io({tmpIO_0__ANALOG_IN_net[0:0]}),
	...
	wire [0:0] tmpFB_0__TX_out_net;
	wire [0:0] tmpIO_0__TX_out_net;
	electrical [0:0] tmpSIOVREF__TX_out_net;

	cy_mxs40_gpio_v1_0
		#(.id("eca53639-fc89-4c46-9582-60d1194ddae0"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
		...
		TX_out
		 (.oe({1'b1}),
		  .y({Net_251}),
		  .fb({tmpFB_0__TX_out_net[0:0]}),
		  .io({tmpIO_0__TX_out_net[0:0]}),
		  .siovref(tmpSIOVREF__TX_out_net));


	wire [0:0] tmpIO_0__RX_in_net;
	electrical [0:0] tmpSIOVREF__RX_in_net;
	...
	cy_mxs40_gpio_v1_0
		...
		RX_in
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({Net_234}),
		  .io({tmpIO_0__RX_in_net[0:0]}),
		  .siovref(tmpSIOVREF__RX_in_net));


	wire [0:0] tmpFB_0__Potentiometer_1_net;
	wire [0:0] tmpIO_0__Potentiometer_1_net;
	electrical [0:0] tmpSIOVREF__Potentiometer_1_net;

	cy_mxs40_gpio_v1_0
		#(.id("9fc2345d-ca83-4a98-ab60-285aac021574"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
		...
		Potentiometer_1
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__Potentiometer_1_net[0:0]}),
		  .analog({Net_249}),
		  .io({tmpIO_0__Potentiometer_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Potentiometer_1_net));


	wire [0:0] tmpFB_0__Potentiometer_2_net;
	wire [0:0] tmpIO_0__Potentiometer_2_net;
	electrical [0:0] tmpSIOVREF__Potentiometer_2_net;

	cy_mxs40_gpio_v1_0
		#(.id("f68e96e8-8ee5-4a90-8e52-a88a5d3ac4f2"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
		...
		Potentiometer_2
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__Potentiometer_2_net[0:0]}),
		  .analog({Net_250}),
		  .io({tmpIO_0__Potentiometer_2_net[0:0]}),
		  .siovref(tmpSIOVREF__Potentiometer_2_net));
	...
	cy_mxs40_gpio_v1_0
		#(.id("a7d9b090-c2e1-47b5-b457-dc459a5c4917"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
